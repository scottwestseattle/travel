...
<!--------------------------------------------------------------------------------------->
<center>
  <div style="padding-top: 20px; padding-bottom: 5px; background-color: white; background-image: url('/img/theme1/insta-bg.png'); background-repeat: repeat;">
...
@component('comments.comp-add-form', ['marginTop' => 0, 'backgroundColor' => 'sectionGreen'])@endcomponent
