@if (Auth::user() && Auth::user()->user_type >= 1000)
	<div class="submenu-view">
		<table><tr>
			...
			<td><a href='/{{$prefix}}/index/nonzero'><span class="glyphCustom glyphicon glyphicon-th"></span></a></td>
			<td><a href='/{{$prefix}}/index/all'><span class="glyphCustom glyphicon glyphicon-th-list"></span></a></td>
