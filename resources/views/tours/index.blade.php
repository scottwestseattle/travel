...
<div class="page-size container text-center">
			...
			<div class="sectionHeader hidden-xs">
				...
				<h1 style="margin-bottom:0;padding-bottom:0" class="main-font sectionImageBlue">{{$page_title}}</h1>
			</div>	
			
			<div class="sectionHeader hidden-xl hidden-lg hidden-md hidden-sm">
				<!-- div><img src="/img/theme1/bootprint.jpg" /></div -->
				<h2 style="margin-bottom:0;padding-bottom:0" class="main-font sectionImageBlue">{{$page_title}}</h2>
			</div>						
