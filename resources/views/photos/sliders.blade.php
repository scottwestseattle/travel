...
<div class="container page-size">
	...
	<h1 style="font-size:1.5em;">
		...
		@endif
		<span style="margin: 0 5px;">@LANG('ui.Featured Photos') ({{ count($photos) }})</span><span style="font-size:.6em;"><a href="/first">@LANG('ui.Show')</a>&nbsp;&nbsp;<a href="/photos/sliders/all">@LANG('ui.Show All')</a></span>
	</h1>
