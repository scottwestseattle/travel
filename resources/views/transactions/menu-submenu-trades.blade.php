...
<div class="submenu-view">
	<table>
		<tr>
			...
			<td style="width:35px;"><a href='/transactions/summary/'><span class="glyphCustom glyphicon glyphicon-home"></span></a></td>
			...
			<td style="font-size:12px;"><a style="padding:1px 4px; margin:5px 5px 9px 0px;" class="btn btn-primary" href="/transactions/trades/all">Trades</a></td>
