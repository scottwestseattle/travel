...
class FrontPageController extends Controller
{
    ...
    public function index()
    {
		...
		*/
    	...
    	return view('frontpage.index', ['posts' => $posts, 'tours' => $tours, 'sliders' => $sliders, 'locations' => $locations, 'page_title' => 'Self-guided Tours, Hikes, and Things to do']);
    }
